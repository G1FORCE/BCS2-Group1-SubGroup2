                        ...
                        <div class="relative md:w-20 md:h-20 w-12 h-12 shrink-0"> 
                            <form id="uploadForm" action="upload-profile-pic.php" method="post" enctype="multipart/form-data">
                                <label for="file" class="cursor-pointer">
                                    <img id="img" src="<?php echo !empty($photo) ? htmlspecialchars($photo) : 'assets/images/avatars/avatar-2.jpg'; ?>" onchange="this.form.submit();" class="object-cover w-full h-full rounded-full" alt=""/>
                                ...
                                <label for="file" class="md:p-1 p-0.5 rounded-full bg-slate-600 md:border-4 border-white absolute -bottom-2 -right-2 cursor-pointer dark:border-slate-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="md:w-4 md:h-4 w-3 h-3 fill-white">
                                        ...
                                        d="M9.344 3.071a49.52 49.52 0 015.312 0c.967.052 
                                        1.83.585 2.332 1.39l.821 1.317c.24.383.645.643 1.11.71.386.054.77.113 
                                        1.152.177 1.432.239 2.429 1.493 2.429 2.909V18a3 3 0 01-3 3h-15a3 3 0 01-3-3V9.574c0-1.416.997-2.67 
                                        2.429-2.909.382-.064.766-.123 1.151-.178a1.56 
                                        1.56 0 001.11-.71l.822-1.315a2.942 2.942 0 012.332-1.39zM6.75 
                                        12.75a5.25 5.25 0 1110.5 0 5.25 5.25 0 01-10.5 
                                        0zm12-1.5a.75.75 0 100-1.5.75.75 0 000 1.5z" clip-rule="evenodd" />
                                    </svg>
                                    <input type="file" id="file"  class="hidden" accept="image/*"/>
                                    <!-- <input type="file" name="profilePicture" class="hidden" id="file" accept="image/*" onchange="uploadProfilePicture()"> -->
